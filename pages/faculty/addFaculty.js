...
import FacultyDrawer from '@/pages/component/facultydrawer'
...
export default function AddFaculty() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post("http://localhost:5000/faculty/insertfaculty",
                formData, {
                headers: {
            ...
            setSuccess('Faculty add successfully');
            reset();
            ...
            setSuccess('Faculty add unsuccessfull ' + error.response.data.message);
        }
    };
